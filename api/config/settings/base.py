...
RENTDIRECT_VAT_BANK_NAME = os.environ.get("RENTDIRECT_VAT_BANK_NAME", "").strip()
RENTDIRECT_VAT_BANK_CODE = os.environ.get("RENTDIRECT_VAT_BANK_CODE", "").strip()
RENTDIRECT_VAT_ACCOUNT_NUMBER = os.environ.get("RENTDIRECT_VAT_ACCOUNT_NUMBER", "").strip()
RENTDIRECT_VAT_ACCOUNT_NAME = os.environ.get("RENTDIRECT_VAT_ACCOUNT_NAME", "RentDirect VAT").strip()
RENTDIRECT_VAT_SUBACCOUNT_ID = os.environ.get("RENTDIRECT_VAT_SUBACCOUNT_ID", "").strip()
RENTDIRECT_VAT_BUSINESS_EMAIL = os.environ.get("RENTDIRECT_VAT_BUSINESS_EMAIL", DEFAULT_FROM_EMAIL).strip()
RENTDIRECT_VAT_BUSINESS_MOBILE = os.environ.get("RENTDIRECT_VAT_BUSINESS_MOBILE", "").strip()
RENTDIRECT_VAT_SUBACCOUNT_COUNTRY = os.environ.get("RENTDIRECT_VAT_SUBACCOUNT_COUNTRY", "NG").strip()
