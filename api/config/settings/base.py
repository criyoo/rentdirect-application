...
PAYMENT_QUEUE_NAME = os.environ.get("PAYMENT_QUEUE_NAME", "rentdirect-payments").strip() or "rentdirect-payments"
PAYMENT_QUEUE_REDIS_URL = os.environ.get("PAYMENT_QUEUE_REDIS_URL", cache_url()).strip()
PAYMENT_QUEUE_URL = os.environ.get("PAYMENT_QUEUE_URL", "").strip()
PAYMENT_QUEUE_AWS_REGION = os.environ.get("PAYMENT_QUEUE_AWS_REGION", os.environ.get("AWS_REGION", "")).strip()
...
PAYMENT_QUEUE_READY_PAYOUT_INTERVAL_SECONDS = env_int(
    "PAYMENT_QUEUE_READY_PAYOUT_INTERVAL_SECONDS",
    env_int("FLUTTERWAVE_PAYOUT_RELEASE_WATCH_INTERVAL_SECONDS", 300),
)
PAYMENT_QUEUE_SUBSCRIPTION_RENEWAL_INTERVAL_SECONDS = env_int(
    "PAYMENT_QUEUE_SUBSCRIPTION_RENEWAL_INTERVAL_SECONDS",
    env_int("SUBSCRIPTION_RENEWAL_WATCH_INTERVAL_SECONDS", 3600),
)
...
FLUTTERWAVE_V4_ALLOW_UNSPLIT_CHECKOUT = env_bool(
    "FLUTTERWAVE_V4_ALLOW_UNSPLIT_CHECKOUT",
...
TENANT_CAUTION_HOLDING_BANK_NAME = os.environ.get("TENANT_CAUTION_HOLDING_BANK_NAME",
...
RENTDIRECT_OPERATING_SUBACCOUNT_ID = os.environ.get("RENTDIRECT_OPERATING_SUBACCOUNT_ID", "").strip()
RENTDIRECT_OPERATING_BUSINESS_EMAIL = os.environ.get("RENTDIRECT_OPERATING_BUSINESS_EMAIL", DEFAULT_FROM_EMAIL).strip()
RENTDIRECT_OPERATING_BUSINESS_MOBILE = os.environ.get("RENTDIRECT_OPERATING_BUSINESS_MOBILE", "").strip()
RENTDIRECT_OPERATING_SUBACCOUNT_COUNTRY = os.environ.get("RENTDIRECT_OPERATING_SUBACCOUNT_COUNTRY", "NG").strip()
RENTDIRECT_OPERATING_SUBACCOUNT_SPLIT_TYPE = os.environ.get("RENTDIRECT_OPERATING_SUBACCOUNT_SPLIT_TYPE", "flat").strip()
RENTDIRECT_OPERATING_SUBACCOUNT_SPLIT_VALUE = os.environ.get("RENTDIRECT_OPERATING_SUBACCOUNT_SPLIT_VALUE", "0").strip()
RENTDIRECT_OPERATING_TRANSACTION_CHARGE_TYPE = os.environ.get("RENTDIRECT_OPERATING_TRANSACTION_CHARGE_TYPE", "flat").strip()
RENTDIRECT_OPERATING_TRANSACTION_CHARGE = os.environ.get("RENTDIRECT_OPERATING_TRANSACTION_CHARGE", "0").strip()

SUBSCRIPTION_VAT_RATE_PERCENT = os.environ.get(
    "SUBSCRIPTION_VAT_RATE_PERCENT",
    str(DEFAULT_SUBSCRIPTION_VAT_RATE_PERCENT),
).strip() or str(DEFAULT_SUBSCRIPTION_VAT_RATE_PERCENT)
RENTDIRECT_VAT_HOLDING_BANK_NAME = os.environ.get("RENTDIRECT_VAT_HOLDING_BANK_NAME", "").strip()
RENTDIRECT_VAT_HOLDING_BANK_CODE = os.environ.get("RENTDIRECT_VAT_HOLDING_BANK_CODE", "").strip()
RENTDIRECT_VAT_HOLDING_ACCOUNT_NUMBER = os.environ.get("RENTDIRECT_VAT_HOLDING_ACCOUNT_NUMBER", "").strip()
RENTDIRECT_VAT_HOLDING_ACCOUNT_NAME = os.environ.get("RENTDIRECT_VAT_HOLDING_ACCOUNT_NAME", "RentDirect VAT Holding").strip()
RENTDIRECT_VAT_HOLDING_SUBACCOUNT_ID = os.environ.get("RENTDIRECT_VAT_HOLDING_SUBACCOUNT_ID", "").strip()
RENTDIRECT_VAT_HOLDING_BUSINESS_EMAIL = os.environ.get("RENTDIRECT_VAT_HOLDING_BUSINESS_EMAIL", DEFAULT_FROM_EMAIL).strip()
RENTDIRECT_VAT_HOLDING_BUSINESS_MOBILE = os.environ.get("RENTDIRECT_VAT_HOLDING_BUSINESS_MOBILE", "").strip()
RENTDIRECT_VAT_HOLDING_SUBACCOUNT_COUNTRY = os.environ.get("RENTDIRECT_VAT_HOLDING_SUBACCOUNT_COUNTRY", "NG").strip()

VERIFICATION_SERVICE = os.environ.get("VERIFICATION_SERVICE", "prembly").strip().lower()
