...
DEFAULT_LANDLORD_PAYOUT_BANK_NAME = os.environ.get(
    "DEFAULT_LANDLORD_PAYOUT_BANK_NAME",
    "Palm Pay" if USE_TEST_PAYOUT_ACCOUNT_DEFAULTS else "",
).strip()
DEFAULT_LANDLORD_PAYOUT_BANK_CODE = os.environ.get("DEFAULT_LANDLORD_PAYOUT_BANK_CODE", "").strip()
DEFAULT_LANDLORD_PAYOUT_ACCOUNT_NUMBER = os.environ.get(
    "DEFAULT_LANDLORD_PAYOUT_ACCOUNT_NUMBER",
    "9041487757" if USE_TEST_PAYOUT_ACCOUNT_DEFAULTS else "",
).strip()
DEFAULT_LANDLORD_PAYOUT_ACCOUNT_NAME = os.environ.get("DEFAULT_LANDLORD_PAYOUT_ACCOUNT_NAME", "RentDirect Landlord").strip()
