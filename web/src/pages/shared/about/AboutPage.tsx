...
export default function AboutPage() {
    const blocks = useMemo(() => parseMarkdown(aboutContent), [])
                ...
                <div className="container-modern py-14 md:py-20">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="mt-6 text-4xl font-bold tracking-tight text-slate-950 md:text-5xl">
                            A more transparent rental experience for landlords and tenants.
                        </h1>
                        <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">
                            Learn why RentDirect exists, what we are building, and how the platform removes unnecessary friction from renting.
                        </p>
