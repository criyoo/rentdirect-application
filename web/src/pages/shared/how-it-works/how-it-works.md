...
RentDirect brings verified homes, people, payments, and rental progress into one connected experience. Choose the path that fits you and move forward with a clearer view of every step.
...
Tenant and landlord verification typically takes 1–2 business days. Property document verification may take longer when additional checks are required.

### What payment methods are accepted?

RentDirect supports card and bank-transfer payments through Flutterwave.

### Can a landlord list more than one property?

Yes. Verified landlords can manage multiple listings from one dashboard.
