            ...
            <div className="container-modern">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 gap-3 lg:grid-cols-5">
                        ...
                        {canSeePropertyVerification && (() => {
                            ...
                            return (
                                <div className={`h-[20rem] overflow-y-auto rounded-2xl border p-6 shadow-lg ${isPropertyVerified
                                    ...
                                    <p className={`text-[16px] font-bold ${isPropertyVerified ? 'text-emerald-900' : 'text-red-900'}`}>
                                        Verification Status
                                    </p>
                        ...
                        {/* Location with Map */}
                        <div className="h-[20rem] overflow-y-auto rounded-2xl bg-white p-6 shadow-lg border text-center">
